 ...
 */
import { AlertTriangle, CalendarClock, PackageMinus, MailOpen, UserPlus } from 'lucide-react'
...
export const NOTIFICATION_TYPES = [
    ...
    { value: 'USER_JOINED', icon: UserPlus, accent: 'text-sky-600 dark:text-sky-400' },
]
